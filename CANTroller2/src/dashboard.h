...
void dash_draw()
{
  ...
  //.....................................drawing  TEXT
  sprite.setTextColor(TFT_WHITE,backColor);
  sprite.drawString(String((int)(*pspeed),cx,cy,4);
  ...
  sprite.drawString("x100",320-cx,136);
...
void update_data(float* speed, float* tach) {  // float* pressure, float* brakemotor, float* gasservo, float* steermotor, int32_t* runmode, bool* ign) {
    pspeed = speed;
    ptach = tach;
}
int blinking=1;

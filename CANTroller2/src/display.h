...
static constexpr uint8_t unitmaps[20][13] = {  // now 13x7-pixel bitmaps for unit strings. required when string is over 2 characters
    ...
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x20, 0x7f, 0x00, 0x00, 0x7f, 0x02, 0x04, },  // up/down arrows to indicate multiple choices. this one is right-aligned one char over to allow longer names

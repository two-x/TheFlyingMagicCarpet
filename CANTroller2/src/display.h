...
uint8_t unitmaps[5][17] = {  // 17x7-pixel bitmaps to represent units that use symbols not present in the font or that are longer than 3 characters
    { 0x7e, 0x04, 0x7c, 0x04, 0x00, 0x30, 0x4a, 0x52, 0x3c, 0x00, 0x06, 0x18, 0x60, 0x00, 0x34, 0x54, 0x4c, },  // ug/s - for manifold mass airflow
    { 0x02, 0x7e, 0x04, 0x04, 0x38, 0x04, 0x00, 0x24, 0x54, 0x54, 0x54, 0x48, 0x00, 0x00, 0x00, 0x00, 0x00, },  // us - b/c the font's "mu" character doesn't work
    { 0x78, 0x40, 0x00, 0x7e, 0x48, 0x30, 0x00, 0x78, 0x40, 0x38, 0x40, 0x38, 0x02, 0x3c, 0x40, 0x1a, 0x2e, },  // rpm/s (or rot/m*s) - rate of change of engine rpm
    { 0x20, 0x40, 0xfe, 0x40, 0x20, 0x00, 0x08, 0x04, 0xfe, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, },  // scroll arrows - to indicate multiple choice
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7c, 0x00, 0x00, 0x38, 0x44, 0x44, 0x38, 0x00, 0x00, },  // 0/1 - to indicate binary value
};
// Fail gallery:  (some alternatives to the above I didn't like as much)
// { 0x7c, 0x82, 0xa2, 0x92, 0x8a, 0x92, 0xa2, 0x82, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, },  // dropdown widget symbol
// { 0x10, 0x38, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x7c, 0x00, 0x7c, 0x00, 0x7c, 0x00, 0x00, 0x7c, 0x38, 0x10, },  // stylized scroll bar
// { 0x1c, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x3e, 0x22, 0x22, 0x46, 0x46, 0x8a, 0xfa, 0x8a, 0x46, 0x3c, },  // clipart rocker switch
        ...
        void update() {
            ...
            if ((dispRefreshTimer.expired() && !_procrastinate) || _disp_redraw_all) {
                ...
                if (dataset_page == PG_RUN) {
                    ...
                    draw_dynamic(14, airflow.max_mph(), 0.0, airflow.abs_max_mph());

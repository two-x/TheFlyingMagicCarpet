...
static constexpr uint8_t unitmaps[9][17] = {  // 17x7-pixel bitmaps for where units use symbols not present in the font, are longer than 3 characters, or are just special
    ...
    { 0x08, 0x1c, 0x2a, 0x08, 0x00, 0x3e, 0x63, 0x73, 0x77, 0x7f, 0x41, 0x7f, 0x73, 0x73, 0x77, 0x7f, 0x3e, },  // googly eyes, are as goofy as they are stupid
...
class Display {
  private:
    ...
    TunerPanel tuner;
    IdiotLights* idiots;
    Timer dispRefreshTimer = Timer(3000);  // Don't refresh screen faster than this (16667us = 60fps, 33333us = 30fps, 66666us = 15fps)

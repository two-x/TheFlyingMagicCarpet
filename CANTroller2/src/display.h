...
class Display {
  private:
    ...
    bool _procrastinate = false, reset_finished = false, simulating_last, fullscreen_last = false;
  ...
  public:
    ...
    bool disp_sidemenu_dirty, disp_runmode_dirty, disp_simbuttons_dirty, disp_idiots_dirty, reset_requested = false;
    bool auto_saver_enabled = false, request_reset = false;
    ...
    void init_tasks() {
        ...
        xTaskCreatePinnedToCore(push_task_wrapper, "taskPush", 2048, NULL, 2, &pushTaskHandle, CONFIG_ARDUINO_RUNNING_CORE);  // 16384

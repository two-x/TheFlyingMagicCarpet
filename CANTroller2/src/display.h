...
// Fail gallery:
// { 0x7c, 0x82, 0xa2, 0x92, 0x8a, 0x92, 0xa2, 0x82, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, },  // scroll dropdown
// { 0x10, 0x38, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x7c, 0x00, 0x7c, 0x00, 0x7c, 0x00, 0x00, 0x7c, 0x38, 0x10, },  // scroll
// { 0x1c, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22, 0x3e, 0x22, 0x22, 0x46, 0x46, 0x8a, 0xfa, 0x8a, 0x46, 0x3c, },  // b1nary switch (alt)
    ...
    public:
        ...
        void saver_update() {
            if (saverRefreshTimer.expireset()) {
                ...
                else if (saver_lines_mode == 1) _saver.drawString("do drugs", disp_saver_width / 2, disp_saver_height / 2, 4);

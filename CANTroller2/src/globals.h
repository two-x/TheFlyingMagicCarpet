...
#define  encoder_sw_pin  1 // button0/strap1   // Input, Rotary encoder push switch, for the UI. active low (needs pullup). Also the esp "Boot" button does the same thing
#define        free_pin  0 // adc1.0           // Available

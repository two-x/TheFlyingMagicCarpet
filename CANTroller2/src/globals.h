...
bool two_click_starter = true;       // to start the starter requires two requests within a timeframe
...
bool nowtouch = false, tapped = false, doubletapped = false, longpressed = false, swiped = false;  // touchscreen globals

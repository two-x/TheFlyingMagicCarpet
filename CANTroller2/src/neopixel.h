...
class IdiotLights {
  public:
    ...
    bool* vals[iconcount] = {
        ...
        &cruise_adjusting, &car_hasnt_moved, &starter.req_on, &starter.motor, &powering_up, &web_disabled, &fuelpump.fuelpump_off,
    ...
    uint8_t icon[iconcount][11] = {
        ...
        { 0x7a, 0x7f, 0x4f, 0x17, 0x06, 0x00, 0x02, 0x5b, 0x59, 0x0f, 0x06, },  // 5 = hotrc w/ "?"
        ...
        { 0x7c, 0x46, 0x7f, 0x7f, 0x33, 0x12, 0x12, 0x12, 0x1e, 0x12, 0x0c, },  // 8 = linear actuator or schlong
        ...
        { 0x7f, 0x19, 0x6e, 0x00, 0x7f, 0x49, 0x63, 0x00, 0x3e, 0x23, 0x7e, },  // 13 = "REQ"
     ...
     // { 0x0e, 0x1d, 0x7d, 0x1d, 0x0e, 0x00, 0x7f, 0x49, 0x49, 0x7f, 0x36, },  // 19 = encoder "B"
     // { 0x02, 0x07, 0x32, 0x78, 0x78, 0x30, 0x00, 0x06, 0x0f, 0x0f, 0x06, },  // 20 - balls

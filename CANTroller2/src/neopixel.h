...
class IdiotLights {
  public:
    ...
    bool* vals[iconcount] = {  // 6 per line
        ...
        &starter.motor, &fuelpump.status_inverse, &brake.posn_pid_active, &bootbutton.now, &nowtouch, speedo.pin_inactive_ptr(),
        tach.pin_inactive_ptr(), &encoder.enc_a, sim.enabled_ptr(), &brake.no_feedback, &running_on_devboard, &not_syspower,
    ...
    uint8_t icon[iconcount][11] = {
        ...
        { 0x4c, 0x2a, 0x19, 0x63, 0x63, 0x77, 0x3e, 0x00, 0x3b, 0x3d, 0x1d  },  // "S" magnet w/ zap
        { 0x4c, 0x2a, 0x19, 0x63, 0x63, 0x77, 0x3e, 0x00, 0x03, 0x3f, 0x03  },  // "T" magnet w/ zap
        ...
        { 0x7e, 0x76, 0x63, 0x7b, 0x7e, 0x7e, 0x7e, 0x76, 0x77, 0x77, 0x7e, },  // battery
    ...
    std::string letters[iconcount] = {
        "SL", "SR", "\xf7""E", "\xf7""W", "RC", "P\x13", "SI", "Pw", "Pk", "AS", "AH", "Aj",  // 12 per row 
        "HM", "St", "FP",      "Pn",      "Bt", "NT",    "SM", "TM", "eA", "NF", "WD", "Dv",
        "Th", "Br", "St",      "RC",      "Sp", "Tc",    "Pr", "Ps", "Tm", "Bt", "Ot", "IO",
    };
    uint8_t color[2][iconcount] = {
     // Colors gradiated for 12 per row
        { 0xa0, 0xd0, 0xb4, 0x74, 0x14, 0x1a, 0x16, 0x0e, 0x02, 0x62, 0xa2, 0xc1,
          0xa0, 0xd0, 0xb4, 0x74, 0x14, 0x1a, 0x16, 0x0e, 0x02, 0x62, 0xa2, 0xc1,
          0xa0, 0xd0, 0xb4, 0x74, 0x14, 0x1a, 0x16, 0x0e, 0x02, 0x62, 0xa2, 0xc1, },
        { 0xe0, 0xec, 0xfc, 0x9c, 0x1c, 0x1e, 0x1f, 0x13, 0x03, 0x83, 0xe3, 0xe1, 
          0xe0, 0xec, 0xfc, 0x9c, 0x1c, 0x1e, 0x1f, 0x13, 0x03, 0x83, 0xe3, 0xe1, 
          0xe0, 0xec, 0xfc, 0x9c, 0x1c, 0x1e, 0x1f, 0x13, 0x03, 0x83, 0xe3, 0xe1, }
    };

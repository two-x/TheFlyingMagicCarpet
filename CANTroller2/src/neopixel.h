...
class IdiotLights {
  public:
    ...
    bool* vals[iconcount] = {
        ...
        &brake.posn_pid_active, &bootbutton.now, &nowtouch, tach.pin_activity_ptr(), &encoder.enc_a, sim.enabled_ptr(), &web_disabled, 
    ...
    };  // , &encoder.enc_b, &starter.req_active,  
    ...
    std::string letters[iconcount] = {
        ...
        "HM", "St", "FP",      "Pn",      "Bt", "NT",    "Mg", "eA", "Sm", "WD", "Dv",

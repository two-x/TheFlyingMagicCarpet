...
class IdiotLights {
  ...
  public:
    ...
    uint8_t icon[iconcount][11] = {  // this array really shouldn't be public, needs a getter function
        ...
        { 0x22, 0x36, 0x1a, 0x08, 0x1a, 0x36, 0x22, 0x00, 0x6e, 0x6b, 0x3b, },  // "S" w/ X                     // speedo.stopped_ptr()
        { 0x22, 0x36, 0x1a, 0x08, 0x1a, 0x36, 0x22, 0x00, 0x06, 0x7e, 0x06, },  // "T" w/ X                     // tach.stopped_ptr()

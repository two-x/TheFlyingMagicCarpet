...
//   private: bool fixed_one = true, fixed_zero = false; bool* _one = &fixed_one; bool* _zero = &fixed_zero;
  ...
  public:
    ...
    bool* vals[iconcount] = {  // 6 per line
        ...
        &shutting_down, &parking, &brake.autostopping, &brake.autoholding, ptr_zero, &cruise_adjusting, &car_hasnt_moved, 
        &starter.motor, fuelpump.status_inverse_ptr(), &brake.no_feedback, speedo.pin_inactive_ptr(), tach.pin_inactive_ptr(), // &brake.posn_pid_active, speedo.pin_level_ptr(), tach.pin_level_ptr() 

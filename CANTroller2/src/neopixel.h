...
class IdiotLights {
  public:
    ...
    bool* vals[iconcount] = {
        ...
        // tach.pin_activity_ptr(),
        &starter.req_active,
        &starter.motor, &powering_up, &web_disabled, &fuelpump.status_inverse,
    ...
    uint8_t icon[iconcount][11] = {
        ...
        { 0x00, 0x00, 0x00, 0x7a, 0x7f, 0x4f, 0x17, 0x06, 0x00, 0x00, 0x00, },  // sensor - hotrc
        ...
        { 0x2a, 0x2a, 0x2a, 0x7f, 0x79, 0x7f, 0x7f, 0x7f, 0x2a, 0x2a, 0x2a, },  // sensor - chip
    };
     // { 0x7a, 0x7f, 0x4f, 0x17, 0x06, 0x00, 0x02, 0x5b, 0x59, 0x0f, 0x06, },  // 4 = hotrc w/ "?"
     ...
     // { 0x0e, 0x1d, 0x7d, 0x1d, 0x0e, 0x00, 0x7e, 0x0b, 0x09, 0x0b, 0x7e, },  // 20 = encoder "A"

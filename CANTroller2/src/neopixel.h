...
class IdiotLights {
  public:
    ...
    bool* vals[iconcount] = {
        &diag.err_sens_alarm[LOST], &diag.err_sens_alarm[RANGE], &diag.err_sens[RANGE][_TempEng], &diag.err_sens[RANGE][_TempWheel], hotrc.radiolost_ptr(),
    ...
    std::string letters[iconcount] = {
        ...
        "HM", "St", "FP",      "Pn",      "Bt", "NT",    "Mg", "eA", "NF", "WD", "Dv",

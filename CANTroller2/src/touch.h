...
public:
    ...
    void update() {
        ...
        if (tcol == 2 && trow == 0) {
            ...
            else if (tcol == 3 && trow == 4 && sim.can_sim(sens::joy)) adj_val(&hotrc.pc[HORZ][FILT], -tedit, hotrc.pc[HORZ][MIN], hotrc.pc[HORZ][MAX]);
            ...
            else if (tcol == 4 && trow == 3 && sim.can_sim(sens::joy)) adj_val(&hotrc.pc[VERT][FILT], tedit, hotrc.pc[VERT][MIN], hotrc.pc[VERT][MAX]);
            else if (tcol == 4 && trow == 4 && sim.can_sim(sens::joy)) adj_val(&hotrc.pc[VERT][FILT], -tedit, hotrc.pc[VERT][MIN], hotrc.pc[VERT][MAX]);
